...
class JConfig
{
	...
	public function get($key, $def = null)
	{
		...
		switch ($key)
		{
			case 'list_limit':
				/**
				 * Try to use the list limit that belongs to the current plugin.
				 *
				 * @since 10.1.23
				 */
				...
				/**
				 * Try to use a global option for the list limit of the current plugin.
				 *
				 * @since 10.1.33
				 */
				$plugin = str_replace('com_', '', $app->input->get('option', ''));
