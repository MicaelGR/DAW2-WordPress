		...
		<table cellspacing="1" class="admintable table">
			<tbody>
				...
				<tr>
					...
					<td><input type="number" step="any" min="0" name="trkcookierfrdur" value="<?php echo JHtml::_('esc_attr', $trksettings['trkcookierfrdur']); ?>" /> (<?php echo strtolower(JText::_('VRDAYS')); ?>)</td>
				</tr>
				<tr>
