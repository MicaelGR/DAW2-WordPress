						...
						<div class="vrc-bookingdet-summary-car vrc-editbooking-summary-car vrc-editbooking-summary-totpaid">
							<div class="vrc-editbooking-summary-car-head">
								<div class="vrc-editbooking-ordtot">
									...
									<?php echo $currencysymb; ?> <input type="number" min="0" step="any" id="order_total" name="order_total" value="" placeholder="<?php echo JHtml::_('esc_attr', $row['order_total']); ?>" style="margin: 0; width: 80px !important;"/>
								</div>
					...
					<div class="vrc-editbooking-tbl">
						...
						<div class="vrc-bookingdet-summary-car vrc-editbooking-summary-car vrc-editbooking-summary-totpaid">
							<div class="vrc-editbooking-summary-car-head">
								<div class="vrc-editbooking-ordtot">
									<label for="order_total"><?php echo JText::_('VREDITORDERNINE'); ?></label>
									<?php echo $currencysymb; ?> <input type="number" min="0" step="any" id="order_total" name="order_total" value="<?php echo (float)$row['order_total']; ?>" placeholder="<?php echo JHtml::_('esc_attr', $row['order_total']); ?>" style="margin: 0; width: 80px !important;"/>
								</div>
								<div class="vrc-editbooking-totpaid">
									<label for="totpaid"><?php echo JText::_('VRCAMOUNTPAID'); ?></label>
									<?php echo $currencysymb; ?> <input type="number" min="0" step="any" id="totpaid" name="totpaid" value="<?php echo !is_null($row['totpaid']) ? (float)$row['totpaid'] : ''; ?>" style="margin: 0; width: 80px !important;"/>
